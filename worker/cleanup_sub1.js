...
async function initializeCleanupSub1(mongoose) {
  try {
    const InfoModel = require('../model/information_model_sub');
    const HitModel = require('../model/hit_model_sub');
      ...
      try {
       // Check MongoDB connection before running cleanup
        if (mongoose.connection.readyState !== 1) {
          console.warn('⚠️cleanup_sub1 MongoDB not connected. Attempting to reconnect...');
...
module.exports = { initializeCleanupSub1 };
